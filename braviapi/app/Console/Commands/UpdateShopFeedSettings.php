...
class UpdateShopFeedSettings extends Command
{
    /**
     * The name and signature of the console command.
     * @var string
     */
    protected $signature = 'shopFeed:update.settings {id?}';

    /**
     * The console command description.
     * @var string
     */
    protected $description = 'Atualiza o objeto de settings da loja';
    ...
    public function handle()
    {
        ...
        foreach ($stores as $store) {
            dispatch(new SendShopFeedEvent($store->id, 'settings:update'));
