...
class UpdateShopFeedServiceArea extends Command
{
    /**
     * The name and signature of the console command.
     * @var string
     */
    protected $signature = 'shopFeed:update.serviceArea {id?}';
    ...
    public function handle()
    {
        ...
        foreach ($stores as $store) {
            dispatch(new SendShopFeedEvent($store->id, 'service_area:update'));
